...
# --- UPDATED & SECURE: Read secrets directly from environment ---
...
# Initialize Twilio client directly from environment variables
try:
    TWILIO_ACCOUNT_SID = os.environ.get("TWILIO_ACCOUNT_SID")
    TWILIO_AUTH_TOKEN = os.environ.get("TWILIO_AUTH_TOKEN")
    TWILIO_PHONE_NUMBER = os.environ.get("TWILIO_PHONE_NUMBER")
    HEALTH_OFFICIAL_PHONE = os.environ.get("HEALTH_OFFICIAL_PHONE")
...
class PatientData(BaseModel):
    ...
    Village: str = Field(..., example="Khonoma")
...
def send_sms_alert(village, state, num_cases, avg_risk):
    if not twilio_client or not HEALTH_OFFICIAL_PHONE:
